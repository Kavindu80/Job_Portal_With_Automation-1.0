...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = "http://44.223.250.83:4000/api/v1/job/getall?";
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `http://44.223.250.83:4000/api/v1/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `http://44.223.250.83:4000/api/v1/job/post`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `http://44.223.250.83:4000/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `http://44.223.250.83:4000/api/v1/job/delete/${id}`,
      { withCredentials: true }
    );
